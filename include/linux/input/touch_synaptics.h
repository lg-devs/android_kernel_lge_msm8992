...
struct palm_data {
	bool curr_mask[MAX_NUM_OF_FINGERS];
	bool prev_mask[MAX_NUM_OF_FINGERS];
	struct point coordinate[MAX_NUM_OF_FINGERS];
	u8 curr_num;
	u8 prev_num;
	bool all_released;
};
...
struct swipe_ctrl_info {
	...
	u8	min_distance_reg;
	u8	ratio_thres_reg;
	u8	ratio_chk_period_reg;
	u8	ratio_chk_min_distance_reg;
	u8	min_time_thres_reg;
	u8	max_time_thres_reg;
	u8	active_area_x0_reg;
	u8	active_area_y0_reg;
	u8	active_area_x1_reg;
	u8	active_area_y1_reg;
};
...
struct swipe_data {
	...
	u8	gesture_mask;
	u8	enable_reg;
	u8	coordinate_start_reg;
	u8	coordinate_end_reg;
	u8	fail_reason_reg;
	u8	time_reg;
...
enum {
	NO_SUPPORT_SWIPE	= 0,
	SUPPORT_SWIPE_DOWN	= 1 << 0,
	SUPPORT_SWIPE_UP	= 1 << 1,
};
